...
+   [JUC工具类: Phaser详解](#juc%E5%B7%A5%E5%85%B7%E7%B1%BB-phaser%E8%AF%A6%E8%A7%A3)
    +   [带着BAT大厂的面试问题去理解Phaser工具](#%E5%B8%A6%E7%9D%80bat%E5%A4%A7%E5%8E%82%E7%9A%84%E9%9D%A2%E8%AF%95%E9%97%AE%E9%A2%98%E5%8E%BB%E7%90%86%E8%A7%A3phaser%E5%B7%A5%E5%85%B7)
    +   [Phaser运行机制](#phaser%E8%BF%90%E8%A1%8C%E6%9C%BA%E5%88%B6)
    +   [Phaser源码详解](#phaser%E6%BA%90%E7%A0%81%E8%AF%A6%E8%A7%A3)
        +   [核心参数](#%E6%A0%B8%E5%BF%83%E5%8F%82%E6%95%B0)
        +   [函数列表](#%E5%87%BD%E6%95%B0%E5%88%97%E8%A1%A8)
        +   [方法 - register()](#%E6%96%B9%E6%B3%95---register)
        +   [方法 - arrive()](#%E6%96%B9%E6%B3%95---arrive)
        +   [方法 - arriveAndAwaitAdvance()](#%E6%96%B9%E6%B3%95---arriveandawaitadvance)
        +   [方法 - awaitAdvance(int phase)](#%E6%96%B9%E6%B3%95---awaitadvanceint-phase)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-phaser-1.png)
...
和CyclicBarrier一样，Phaser也可以重复await。方法arriveAndAwaitAdvance的效果类似CyclicBarrier.await。phaser的每一代都有一个相关的phase number，初始值为0，当所有注册的任务都到达phaser时phase+1，到达最大值(Integer.MAX\_VALUE)之后清零。使用phase number可以独立控制 到达phaser 和 等待其他线程 的动作，通过下面两种类型的方法:
...
+   循环SPINS\_PER\_ARRIVAL指定的次数或者当前线程被中断，创建node记录等待线程及相关信息。
...
+   引用 https://www.pdai.tech/md/java/thread/java-thread-x-juc-tool-phaser.html