...
+   [JUC线程池: ScheduledThreadPoolExecutor详解](#juc%E7%BA%BF%E7%A8%8B%E6%B1%A0-scheduledthreadpoolexecutor%E8%AF%A6%E8%A7%A3)
    +   [带着BAT大厂的面试问题去理解ScheduledThreadPoolExecutor](#%E5%B8%A6%E7%9D%80bat%E5%A4%A7%E5%8E%82%E7%9A%84%E9%9D%A2%E8%AF%95%E9%97%AE%E9%A2%98%E5%8E%BB%E7%90%86%E8%A7%A3scheduledthreadpoolexecutor)
    +   [ScheduledThreadPoolExecutor简介](#scheduledthreadpoolexecutor%E7%AE%80%E4%BB%8B)
    +   [ScheduledThreadPoolExecutor数据结构](#scheduledthreadpoolexecutor%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84)
    +   [ScheduledThreadPoolExecutor源码解析](#scheduledthreadpoolexecutor%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90)
        +   [内部类ScheduledFutureTask](#%E5%86%85%E9%83%A8%E7%B1%BBscheduledfuturetask)
            +   [属性](#%E5%B1%9E%E6%80%A7)
            +   [核心方法run()](#%E6%A0%B8%E5%BF%83%E6%96%B9%E6%B3%95run)
            +   [cancel方法](#cancel%E6%96%B9%E6%B3%95)
        +   [核心属性](#%E6%A0%B8%E5%BF%83%E5%B1%9E%E6%80%A7)
        +   [构造函数](#%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)
        +   [核心方法:Schedule](#%E6%A0%B8%E5%BF%83%E6%96%B9%E6%B3%95schedule)
        +   [核心方法:scheduleAtFixedRate 和 scheduleWithFixedDelay](#%E6%A0%B8%E5%BF%83%E6%96%B9%E6%B3%95scheduleatfixedrate-%E5%92%8C-schedulewithfixeddelay)
        +   [核心方法:shutdown()](#%E6%A0%B8%E5%BF%83%E6%96%B9%E6%B3%95shutdown)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-stpe-1.png)
...
例如: 由于 ScheduledThreadPoolExecutor 是一个固定核心线程数大小的线程池，并且使用了一个无界队列，所以调整maximumPoolSize对其没有任何影响(所以 ScheduledThreadPoolExecutor 没有提供可以调整最大线程数的构造函数，默认最大线程数固定为Integer.MAX\_VALUE)。此外，设置corePoolSize为0或者设置核心线程空闲后清除(allowCoreThreadTimeOut)同样也不是一个好的策略，因为一旦周期任务到达某一次运行周期时，可能导致线程池内没有线程去处理这些任务。
...
+   引用 https://www.pdai.tech/md/java/thread/java-thread-x-juc-executor-ScheduledThreadPoolExecutor.html