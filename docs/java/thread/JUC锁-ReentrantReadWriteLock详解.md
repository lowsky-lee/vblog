...
+   [JUC锁: ReentrantReadWriteLock详解](#juc%E9%94%81-reentrantreadwritelock%E8%AF%A6%E8%A7%A3)
    ...
    +   [ReentrantReadWriteLock数据结构](#reentrantreadwritelock%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84)
    +   [ReentrantReadWriteLock源码分析](#reentrantreadwritelock%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90)
        +   [类的继承关系](#%E7%B1%BB%E7%9A%84%E7%BB%A7%E6%89%BF%E5%85%B3%E7%B3%BB)
        +   [类的内部类](#%E7%B1%BB%E7%9A%84%E5%86%85%E9%83%A8%E7%B1%BB)
        +   [内部类 - Sync类](#%E5%86%85%E9%83%A8%E7%B1%BB---sync%E7%B1%BB)
        +   [内部类 - Sync核心函数分析](#%E5%86%85%E9%83%A8%E7%B1%BB---sync%E6%A0%B8%E5%BF%83%E5%87%BD%E6%95%B0%E5%88%86%E6%9E%90)
    ...
    +   [ReentrantReadWriteLock示例](#reentrantreadwritelock%E7%A4%BA%E4%BE%8B)
    +   [更深入理解](#%E6%9B%B4%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3)
        +   [什么是锁升降级?](#%E4%BB%80%E4%B9%88%E6%98%AF%E9%94%81%E5%8D%87%E9%99%8D%E7%BA%A7)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-1.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-2.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-3.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-4.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-5.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-6.png)

+   rt1线程执行rrwLock.readLock().lock操作，主要的函数调用如下。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-7.png)

说明: 此时，AQS的状态state为2^16 次方，即表示此时读线程数量为1。

+   rt2线程执行rrwLock.readLock().lock操作，主要的函数调用如下。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-8.png)

说明: 此时，AQS的状态state为2 \* 2^16次方，即表示此时读线程数量为2。

+   wt1线程执行rrwLock.writeLock().lock操作，主要的函数调用如下。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-9.png)

说明: 此时，在同步队列Sync queue中存在两个结点，并且wt1线程会被禁止运行。

+   rt1线程执行rrwLock.readLock().unlock操作，主要的函数调用如下。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-10.png)

说明: 此时，AQS的state为2^16次方，表示还有一个读线程。

+   rt2线程执行rrwLock.readLock().unlock操作，主要的函数调用如下。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-11.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-12.png)

说明: 最后，sync queue队列中只有一个结点，并且头节点尾节点均指向它，AQS的state值为1，表示此时有一个写线程。

+   wt1执行rrwLock.writeLock().unlock操作，主要的函数调用如下。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-readwritelock-13.png)
...
+   引用 https://www.pdai.tech/md/java/thread/java-thread-x-lock-ReentrantReadWriteLock.html