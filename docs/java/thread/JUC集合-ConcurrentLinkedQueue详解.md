...
+   [JUC集合: ConcurrentLinkedQueue详解](#juc%E9%9B%86%E5%90%88-concurrentlinkedqueue%E8%AF%A6%E8%A7%A3)
    ...
    +   [ConcurrentLinkedQueue数据结构](#concurrentlinkedqueue%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84)
    +   [ConcurrentLinkedQueue源码分析](#concurrentlinkedqueue%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90)
        ...
        +   [核心函数分析](#%E6%A0%B8%E5%BF%83%E5%87%BD%E6%95%B0%E5%88%86%E6%9E%90)
            +   [offer函数](#offer%E5%87%BD%E6%95%B0)
            +   [poll函数](#poll%E5%87%BD%E6%95%B0)
            +   [remove函数](#remove%E5%87%BD%E6%95%B0)
            +   [size函数](#size%E5%87%BD%E6%95%B0)
    +   [ConcurrentLinkedQueue示例](#concurrentlinkedqueue%E7%A4%BA%E4%BE%8B)
    +   [再深入理解](#%E5%86%8D%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3)
        +   [HOPS(延迟更新的策略)的设计](#hops%E5%BB%B6%E8%BF%9F%E6%9B%B4%E6%96%B0%E7%9A%84%E7%AD%96%E7%95%A5%E7%9A%84%E8%AE%BE%E8%AE%A1)
        +   [ConcurrentLinkedQueue适合的场景](#concurrentlinkedqueue%E9%80%82%E5%90%88%E7%9A%84%E5%9C%BA%E6%99%AF)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-1.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-2.png)

+   若ConcurrentLinkedQueue的初始状态如上图所示，即队列为空。单线程添加元素，此时，添加元素10，则状态如下所示

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-3.png)

+   如上图所示，添加元素10后，tail没有变化，还是指向之前的结点，继续添加元素20，则状态如下所示

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-4.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-5.png)

+   队列初始状态如上图所示，在poll操作后，队列的状态如下图所示

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-6.png)

+   如上图可知，poll操作后，head改变了，并且head所指向的结点的item变为了null。再进行一次poll操作，队列的状态如下图所示。

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-7.png)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-8.png)

+   如上图所示，为ConcurrentLinkedQueue的初始状态，remove(10)后的状态如下图所示

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-9.png)

+   如上图所示，当执行remove(10)后，head指向了head结点之前指向的结点的下一个结点，并且head结点的item域置为null。继续执行remove(20)，状态如下图所示

![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/java-thread-x-juc-concurrentlinkedqueue-10.png)
...
+   引用 https://www.pdai.tech/md/java/thread/java-thread-x-juc-collection-ConcurrentLinkedQueue.html