...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/f76067a5-7d5f-4135-9549-8199c77d8f1c.jpg)
...
相关文章：[Java 基础 - 反射机制详解](https://www.pdai.tech/md/java/basic/java-basic-x-reflection.html)
...
![](https://raw.githubusercontent.com/lowskylee/Pictures/main/images/PPjwP.png)

相关文章：[Java 基础 - 异常机制详解](https://www.pdai.tech/md/java/basic/java-basic-x-exception.html)
...
相关文章：[Java 基础 - 泛型机制详解](https://www.pdai.tech/md/java/basic/java-basic-x-generic.html)

## 注解

Java 注解是附加在代码中的一些元信息，用于一些工具在编译、运行时进行解析和使用，起到说明、配置的功能。注解不会也不能影响代码的实际逻辑，仅仅起到辅助性的作用。

相关文章：[Java 基础 - 注解机制详解](https://www.pdai.tech/md/java/basic/java-basic-x-annotation.html)
...
+   转载 https://www.pdai.tech/md/java/basic/java-basic-lan-basic.html