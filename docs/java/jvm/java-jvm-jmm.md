...
> 本文主要转载自 Info 上[深入理解Java内存模型在新窗口打开](https://www.infoq.cn/article/java_memory_model/), 作者程晓明。这篇文章对JMM讲的很清楚了，大致分三部分：重排序与顺序一致性；三个同步原语（lock，volatile，final）的内存语义，重排序规则及在处理器中的实现；java 内存模型的设计，及其与处理器内存模型和顺序一致性内存模型的关系。@pdai

+   [JVM 基础 - Java 内存模型详解](#jvm-%E5%9F%BA%E7%A1%80---java-%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B%E8%AF%A6%E8%A7%A3)
    ...
    +   [重排序](#%E9%87%8D%E6%8E%92%E5%BA%8F-1)
...
![](https://www.pdai.tech/images/jvm/java-jmm-1.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-2.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-3.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-4.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-5.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-6.png)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![](https://www.pdai.tech/images/jvm/java-jmm-7.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-8.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-9.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-10.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-11.png)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![](https://www.pdai.tech/images/jvm/java-jmm-12.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-13.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-14.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-15.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-x01.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-x02.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-x03.png)
...
![](https://www.pdai.tech/images/jvm/java-jmm-x04.png)
