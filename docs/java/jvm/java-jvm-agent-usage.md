...
> 本文转载自 美团技术团队胡健的[Java 动态调试技术原理及实践在新窗口打开](https://tech.meituan.com/2019/11/07/java-dynamic-debugging-technology.html), 通过学习java agent方式进行动态调试了解目前很多大厂开源的一些基于此的调试工具。 @pdai

+   [调试排错 - Java动态调试技术原理](#%e8%b0%83%e8%af%95%e6%8e%92%e9%94%99---java%e5%8a%a8%e6%80%81%e8%b0%83%e8%af%95%e6%8a%80%e6%9c%af%e5%8e%9f%e7%90%86)
    +   [简介](#%e7%ae%80%e4%bb%8b)
    +   [Agent的实现模式](#agent%e7%9a%84%e5%ae%9e%e7%8e%b0%e6%a8%a1%e5%bc%8f)
        +   [通过Java Instrumentation API](#%e9%80%9a%e8%bf%87java-instrumentation-api)
    +   [启动时加载Agent](#%e5%90%af%e5%8a%a8%e6%97%b6%e5%8a%a0%e8%bd%bdagent)
        +   [参数解析](#%e5%8f%82%e6%95%b0%e8%a7%a3%e6%9e%90)
        +   [执行加载操作](#%e6%89%a7%e8%a1%8c%e5%8a%a0%e8%bd%bd%e6%93%8d%e4%bd%9c)
        +   [instrument动态链接库](#instrument%e5%8a%a8%e6%80%81%e9%93%be%e6%8e%a5%e5%ba%93)
    +   [运行时加载Agent](#%e8%bf%90%e8%a1%8c%e6%97%b6%e5%8a%a0%e8%bd%bdagent)
        +   [AttachListener](#attachlistener)
        +   [运行时加载Agent的实现](#%e8%bf%90%e8%a1%8c%e6%97%b6%e5%8a%a0%e8%bd%bdagent%e7%9a%84%e5%ae%9e%e7%8e%b0)
        +   [load命令的实现](#load%e5%91%bd%e4%bb%a4%e7%9a%84%e5%ae%9e%e7%8e%b0)
    +   [动态字节码修改的限制](#%e5%8a%a8%e6%80%81%e5%ad%97%e8%8a%82%e7%a0%81%e4%bf%ae%e6%94%b9%e7%9a%84%e9%99%90%e5%88%b6)
    +   [重定义类字节码的实现细节](#%e9%87%8d%e5%ae%9a%e4%b9%89%e7%b1%bb%e5%ad%97%e8%8a%82%e7%a0%81%e7%9a%84%e5%ae%9e%e7%8e%b0%e7%bb%86%e8%8a%82)
    +   [Java-debug-tool](#java-debug-tool)
        +   [Java-debug-tool整体架构](#java-debug-tool%e6%95%b4%e4%bd%93%e6%9e%b6%e6%9e%84)
        +   [Java-debug-tool的字节码增强方案](#java-debug-tool%e7%9a%84%e5%ad%97%e8%8a%82%e7%a0%81%e5%a2%9e%e5%bc%ba%e6%96%b9%e6%a1%88)
            +   [字节码增强](#%e5%ad%97%e8%8a%82%e7%a0%81%e5%a2%9e%e5%bc%ba)
            +   [Advice的工作方式](#advice%e7%9a%84%e5%b7%a5%e4%bd%9c%e6%96%b9%e5%bc%8f)
        +   [Java-debug-tool的命令设计与实现](#java-debug-tool%e7%9a%84%e5%91%bd%e4%bb%a4%e8%ae%be%e8%ae%a1%e4%b8%8e%e5%ae%9e%e7%8e%b0)
            +   [命令执行](#%e5%91%bd%e4%bb%a4%e6%89%a7%e8%a1%8c)
            +   [获取方法执行视图](#%e8%8e%b7%e5%8f%96%e6%96%b9%e6%b3%95%e6%89%a7%e8%a1%8c%e8%a7%86%e5%9b%be)
        +   [Java-debug-tool与同类产品对比分析](#java-debug-tool%e4%b8%8e%e5%90%8c%e7%b1%bb%e4%ba%a7%e5%93%81%e5%af%b9%e6%af%94%e5%88%86%e6%9e%90)
...
上述代码片段是经过精简的libinstrument中Agent\_OnLoad实现的，大概的流程就是：先创建一个JPLISAgent，然后将ManiFest中设定的一些参数解析出来， 比如(Premain-Class)等。创建了JPLISAgent之后，调用initializeJPLISAgent对这个Agent进行初始化操作。跟进initializeJPLISAgent看一下是如何初始化的：
...
上面的代码截取自create\_vm函数，DisableAttachMechanism、StartAttachListener和ReduceSignalUsage这三个变量默认都是false，所以AttachListener::init();这行代码不会在create\_vm的时候执行，而vm\_start会执行。下面来看一下这个函数的实现细节：
...
![](https://www.pdai.tech/images/java/java-jvm-agent-1.png)
...
这个函数先确保加载了java.instrument模块，之后真正执行Agent加载的函数是 load\_agent\_library ,这个函数的套路就是加载Agent动态链接库，如果是通过Java instrument API实现的Agent，则加载的是libinstrument动态链接库，然后通过libinstrument里面的代码实现运行agentmain方法的逻辑，这一部分内容和libinstrument实现premain方法运行的逻辑其实差不多，这里不再做分析。至此，我们对Java Agent技术已经有了一个全面而细致的了解。
...
![](https://www.pdai.tech/images/java/java-jvm-agent-2.png)
...
VM\_RedefineClasses实现比较复杂的，详细实现可以参考 [RedefineClasses在新窗口打开](https://github.com/pandening/openjdk/blob/0301fc792ffd3c7b506ef78887af250e0e3ae09e/src/hotspot/share/prims/jvmtiEnv.cpp#L456)的实现。
...
![](https://www.pdai.tech/images/java/java-jvm-agent-3.png)
...
![](https://www.pdai.tech/images/java/java-jvm-agent-4.png)
...
![](https://www.pdai.tech/images/java/java-jvm-agent-5.png)
...
![](https://www.pdai.tech/images/java/java-jvm-agent-6.png)
